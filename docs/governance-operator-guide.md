...
Controlled registries of relationship types, event types, errors and extensions are governed artifacts. Changes require interoperability, security, privacy, migration and conformance analysis.
