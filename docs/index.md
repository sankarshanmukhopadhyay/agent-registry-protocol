...
- [ARPA Core Identity and Discovery Profile](../spec/profiles/arpa-core-identity-discovery-profile.md)
- [ARPA Identifier Profile](../spec/profiles/arpa-identifier-profile.md)
- [ARPA Proof and Digest Profile](../spec/profiles/arpa-proof-and-digest-profile.md)
- [ARPA Agent Card Interoperability Profile](../spec/profiles/arpa-agent-card-interoperability.md)
