...
This GitHub Pages site renders the repository's complete Markdown documentation surface, including the specification and profiles, implementation guides, governance and security material, conformance documentation, interoperability guidance, reference-component documentation, and worked scenarios. Machine-readable schemas, API definitions, registries, mappings, and test artefacts remain available in the source repository.
